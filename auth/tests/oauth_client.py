...
REQUEST_TOKEN_URL = 'http://127.0.0.1:8000/oauth2/token/'
ACCESS_TOKEN_URL = 'http://127.0.0.1:8000/oauth2/token/'
AUTHORIZATION_URL = 'http://127.0.0.1:8000/oauth2/authorize/'
CALLBACK_URL = 'http://printer.example.com/request_token_ready'
RESOURCE_URL = 'http://127.0.0.1:8000/api/email/'

# key and secret granted by the service provider for this consumer application - same as the MockOAuthDataStore
CONSUMER_KEY = 'a1fa866e74afeee92fbb263138d5f9'
CONSUMER_SECRET = '442bc155ca734ebe06a9a7e34e8b26'
...
def run_example():
    ...
    # token.key = {'key':'7bb3c0346c3bac9908afc282d56cbc','secret':'c94cdb8891'}
    token = object()
    token.key = '7bb3c0346c3bac9908afc282d56cbc'
    token.secret = 'c94cdb8891'
    print token
    print 'key: %s' % str(token.key)
    print 'secret: %s' % str(token.secret)
